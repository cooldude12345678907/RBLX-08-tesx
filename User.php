...
<p><span id="ctl00_cphRoblox_rbxUserPane_rbxPublicUser_lBlurb"><?php echo isset($user['description']) && $user['description'] !== null ? htmlspecialchars($user['description']) : ''; ?></span></p>
        </td>
    </tr>
</table>
    <?php
