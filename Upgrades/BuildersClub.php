...
?>
    ...
    <div id="BuildersClubContainer">
        ...
        <div id="MembershipOptions">
            <div id="OneMonth">
                <div class="BuildersClubButton"><a id="ctl00_cphRoblox_GetMonthlyImageLink" href="PaymentMethods.aspx?id=1"><img src="/images/BC/BC.png" style="border-width:0px;" /></a></div>
                <div class="Label"><a id="ctl00_cphRoblox_GetMonthlyHyperLink" href="PaymentMethods.aspx?id=1">Get Monthly</a></div>
            </div>
            <div id="SixMonths">
                <div class="BuildersClubButton"><a id="ctl00_cphRoblox_Get6MonthsImageLink" href="PaymentMethods.aspx?id=2"><img src="/images/BC/BuyBC6Months.png" style="border-width:0px;" /></a></div>
                <div class="Label"><a id="ctl00_cphRoblox_Get6MonthsHyperLink" href="PaymentMethods.aspx?id=2">Get 6 Months</a></div>
            </div>
            <div id="TwelveMonths">
                <div class="BuildersClubButton"><a id="ctl00_cphRoblox_Get12MonthsImageLink" href="PaymentMethods.aspx?id=3"><img src="/images/BC/BuyBC12Months.png" style="border-width:0px;" /></a></div>
        ...
        <h3>Not Ready Yet?</h3>
        <ul id="MembershipBenefits">
            <li id="Benefit_RobuxAllowance">You can also <a href="Robux.aspx">buy ROBUX</a> directly for cash.</li>
        </ul>
    </ul></ul></div>
<?php if($loggedin == 'yes') { 
