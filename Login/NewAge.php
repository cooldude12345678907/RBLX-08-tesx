<?php
require_once($_SERVER['DOCUMENT_ROOT'].'/includes/headerv2.php');
#die("Registration disabled because of funny thing.");
...
$error = 'NULL';
	...
	exit;
      ...
      $sql = "INSERT IGNORE INTO users (id, username, email, password, referral) VALUES (NULL, :username, :email, :password, :referral)";
      $stmt = $db->prepare($sql);
      $stmt->bindParam(':username', $username);
      $stmt->bindParam(':email', $email);
