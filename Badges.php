...
?>
  ...
  <input type="hidden" name="ctl00$cphRoblox$aBadgesAndRankings_AccordionExtender_ClientState" id="ctl00_cphRoblox_aBadgesAndRankings_AccordionExtender_ClientState" value="0"/><div>
            ...
            <div id="CommunityBadges">
              ...
              <div id="FeaturedBadge_Community">
                ...
                <div class="FeaturedBadgeContent">
                  ...
                  <p>Members of the illustrious Builders Club display this badge proudly. The Builders Club is a paid premium service. Members receive several benefits: they get ten places on their account instead of one, they earn a daily income of 15 <?=$bux?>, they can sell their creations to others in the <?=$sitename?> Catalog, they get the ability to browse the web site without external ads, and they receive the exclusive Builders Club construction hat.</p>
                </div>
              </div>
              ...
              <div class="Legend">
                <ul class="BadgesList">
                  <li id="Homestead">
                    ...
                    <div>The homestead badge is earned by having your personal place visited 100 times. Players who achieve this have demonstrated their ability to build cool things that other <?=$sitename2?>ians were interested enough in to check out. Get a jump-start on earning this reward by inviting people to come visit your place.</div>
                  </li>
                  <li id="Bricksmith">
              ...
              <div class="Legend">
                <ul class="BadgesList">
                  <li id="Friendship">
                    ...
                    <div>This badge is given to players who have embraced the <?=$sitename2?> community and have made at least 20 friends. People who have this badge are good people to know and can probably help you out if you are having trouble.</div>
                  </li>
                  <li id="Inviter">
                    <h4>Inviter Badge</h4>
                    <div><?=$sitename2?>ia is a vast uncharted realm, as large as the imagination. Individuals who invite others to join in the effort of mapping this mysterious region are honored in <?=$sitename2?>ian society. Citizens who successfully recruit three or more fellow explorers via the Share <?=$sitename2?> with a Friend mechanism are awarded with this badge.</div>
                  </li>
                </ul>
              </div>
